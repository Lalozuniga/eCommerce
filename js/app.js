const productData = [
    {
        ...
        image: 'img1.jpg',
        des: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum ducimus quidem dolorum dolore quas veniam.'
    },
    {
        index: '02',
...
let productImgContainer = document.querySelector('.product-img-container'); // Fixed selector
let productImg = document.querySelector('.product-img');
let backdropImg = document.querySelector('.backdrop-img');

let productDetail = document.querySelector('.product-detail'); // Fixed selector
...
ntxBtn.addEventListener('click', () => {
    ...
    productImgContainer.classList.add('slide'); // Fixed class name
    ...
    setTimeout(() => {
        ...
        smImg.src = `images/${productData[currentProduct].image}`; // Fixed image source
        productImg.src = `images/${productData[currentProduct].image}`;
        backdropImg.src = `images/${productData[currentProduct].image}`;
    }, 500);

    setTimeout(() => {
        smImgContainer.classList.remove('slide');
        productImgContainer.classList.remove('slide'); // Fixed class name
